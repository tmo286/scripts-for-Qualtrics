define(['pipAPI', 'https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.*/amp/qualtrics/qamp.js'], function(APIConstructor, ampExtension){
	...
	return ampExtension({
		primeCats :  [
			{
				nameForFeedback : 'Chris',  //Will be used in the user feedback 
				nameForLogging : 'Chris', //Will be used in the logging
			...
			{
				nameForFeedback : 'James',  //Will be used in the user feedback 
				nameForLogging : 'James', //Will be used in the logging
				//An array of all media objects for this category.
				mediaArray : [
    		    {image : 'james_cs.jpg'}, 
    			{image : 'james_cs1.jpg'}, 
