			...
			targetCats :  [
				{
					...
					mediaArray : [
						{word : 'Arbel'}, {word: 'Shoham'}, {word : 'Shaked'}, {word : 'Amit'}, {word : 'Zohar'}, {word : 'Omer'}, {word : 'Lotan'}, {word : 'Osher'}, {word : 'Ariel'}, 
						{word : 'Zof'}, {word : 'Yahali'}, {word : 'Carmel'}, {word : 'Shahaf'}, {word : 'Eliya'}, {word : 'Chen'}, {word : 'Yuval'}, {word : 'Or'}, {word : 'Roni'}, {word : 'Almog'}, 
						{word : 'Ziv'}, {word : 'Yahal'}, {word : 'Stav'}, {word : 'Ofir'}, {word : 'Ravid'}, {word : 'Yam'}, {word : 'Gal'}, {word : 'Geffen'}, {word : 'Liron'}, 
						{word : 'Yarden'},{word : 'Noam'}, {word : 'Manor'}, {word : 'Barr'}, {word : 'Tal'}, {word : 'Eliraz'}, {word : 'Asif'}, {word : 'Ofek'}, {word : 'Shoval'},  
						{word : 'Adar'}, {word : 'Nitzan'}, {word : 'Lior'}, {word : 'Paz'}, {word : 'Shai'}, {word : 'Yona'}, {word : 'Rani'}, {word :'Shahar'}, {word : 'Niv'},{word : 'Liel'}, {word : 'Maayan'}, {word : 'Aviv'},{word : 'Daniel'}, {word : 'Liam'}, {word : 'Tom'}, {word : 'Raz'}
					]
